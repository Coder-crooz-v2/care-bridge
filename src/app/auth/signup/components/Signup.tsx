...
export default function SignupPageComponent() {
  ...
  const handleSignup = async () => {
    setLoading(true);
    try {
      signupSchema.parse(formData); // Validate form data against the schema
      ...
      >
        ...
        <div className="flex items-center mb-8 absolute top-0 left-0 p-6">
          <div className="bg-primary rounded p-1 mr-2">
            ...
            <StethoscopeIcon color="white" size={18} />
          </div>
          <span className="text-md font-bold text-primary tracking-wide">
            CareBridge
          </span>
        </div>
