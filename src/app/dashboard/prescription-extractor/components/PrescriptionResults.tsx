            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              {data.date_prescribed && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-medium">{data.date_prescribed}</span>
                </div>
              )}
              {data.pharmacy_name && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-medium">{data.pharmacy_name}</span>
                </div>
              )}
            </div>
          )}
                  ...
                  <div className="space-y-4">
                    ...
                    {(medicine.notes ||
                      ...
                      <div className="pt-2 space-y-3">
                        ...
                        {medicine.notes &&
                          ![
                            "Dosage details not clearly readable from prescription",
                            "Details not clearly visible in prescription image",
                            "None",
                          ].includes(medicine.notes) && (
